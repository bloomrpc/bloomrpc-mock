// IMPORTANT!!!
//
// THIS FILE HAS BEEN COPIED FROM https://github.com/grpc/grpc-node/blob/master/packages/proto-loader/src/index.ts
// FOR THE PURPOSE OF USING A FIX https://github.com/grpc/grpc-node/commit/a6ecc7c8c85fc40cc031a9b55a9acd2e858b3b58
// BEFORE THE TAG HAS BEEN RELEASED.
//
// DELETE THIS FILE AND USE THE APPROPRIATE @grpc/proto-loader ONCE THE RELEASE IS OUT
//
/**
 * @license
...
function createDeserializer(cls: Protobuf.Type, options: Options): Deserialize<object> {
  return function (argBuf: Buffer): object {
    return cls.toObject(cls.decode(argBuf), options);
  };
}

function createSerializer(cls: Protobuf.Type): Serialize<object> {
  return function (arg: object): Buffer {
